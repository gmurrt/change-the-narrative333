    ...
    <div className="flex flex-col min-h-screen">
      <div className="container-custom py-12">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
          ...
          <div className="mt-8">
            <p className="text-center text-muted-foreground mb-4">Or continue with</p>
            <Button className="w-full mb-4 bg-gray-100 hover:bg-gray-200 text-black" onClick={handleGoogleSignIn} disabled={isLoading}>
              <Image
